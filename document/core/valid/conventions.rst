...
* *Element Segments*: the list of element segments declared in the current module, represented by their activeness.
* *Data Segments*: the list of data segments declared in the current module, represented by their activeness.
...
.. math::
   ...
   \production{(context)} & C &::=&
     ...
     \{ & \CTYPES & \functype^\ast, \\
        ...
        & \CELEM & \activeness^\ast, \\
        & \CDATA & \activeness^\ast, \\
        & \CLOCALS & \valtype^\ast, \\
