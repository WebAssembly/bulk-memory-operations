// This program generates a .wast file that contains all the spec tests for
// memory.copy.

// Set this to true once we have shared memory, to get additional testing on
// memory backed by SharedArrayBuffer.
...
`);
    ...
    for (i=0; i < memLength; i++ ) {
        ...
        // Spot-check for zero, or we'll be here all night
